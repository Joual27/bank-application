          ...
          <div class="w-full h-full  mt-10">
              <nav class="mt-5 flex-1 flex flex-col divide-y divide-cyan-800 overflow-x-hidden" aria-label="Sidebar" id="navbar">
                <div class="px-2 space-y-1 mt-10">
                  ...
                  <a href="#" class="bg-cyan-800 text-white group flex items-center px-2 py-2 text-lg leading-6 font-medium rounded-md" aria-current="page">
                  ...
                  <a href="<?= PUBLICROOT?>" class="text-white hover:text-white hover:bg-cyan-600 group flex items-center px-2 py-2 text-lg leading-6 font-medium rounded-md">
